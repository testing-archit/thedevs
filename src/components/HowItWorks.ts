    ...
    <section id="how-it-works" class="py-24 relative">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-5xl font-bold mb-4">How It <span class="gradient-text">Works</span></h2>
                <p class="text-gray-400 text-lg max-w-2xl mx-auto">Get started in minutes and begin your placement prep journey.</p>
            </div>
...
function Step({ number, title, description }: { number: number; title: string; description: string }): string {
    return `
    <div class="text-center">
        <div class="w-20 h-20 mx-auto bg-gradient-to-br from-primary to-secondary rounded-2xl flex items-center justify-center mb-6 text-3xl font-bold">${number}</div>
